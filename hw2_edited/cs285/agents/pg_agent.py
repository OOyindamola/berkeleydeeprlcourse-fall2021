...
class PGAgent(BaseAgent):
    ...
    def calculate_q_vals(self, rewards_list):
        ...
        if not self.reward_to_go:
            ...
            #     print(self._discounted_return(rewards_list[i]))
            #     q_values[i] = self._discounted_return(rewards_list[i])
        ...
        # Estimate Q^{pi}(s_t, a_t) by the discounted sum of rewards starting from t
            ...
            # for i in range(len(rewards_list)):
            #     q_values[i] = self._discounted_cumsum(rewards_list[i])
            ...
            if self.gae_lambda is not None:
                ...
                for i in reversed(range(batch_size)):
                    ...
                    ## HINT 2: self.gae_lambda is the lambda value in the
                        ## GAE formula
                        # advantages[i] = -values[i-1] + rews[i-1] + self.gae_lambda*advantages[i]
                        # advantages = []
