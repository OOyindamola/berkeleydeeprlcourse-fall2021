...
class MLPPolicy(BasePolicy, nn.Module, metaclass=abc.ABCMeta):
    ...
    def get_action(self, obs):
        ...
        return ptu.to_numpy(action) #action
    ...
    def forward(self, observation: torch.FloatTensor) -> Any:
        if self.discrete:
            pi = distributions.Categorical(self.logits_na(observation))
        else:
...
class MLPPolicySL(MLPPolicy):
    ...
    def update(
        ...
        # print(loss.requires_grad, pred_actions.requires_grad, actions.requires_grad)
