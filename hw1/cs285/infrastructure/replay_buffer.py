...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        ind_perm = np.random.permutation(len(self.obs))

        ind = ind_perm[-batch_size:]

        ob_batch = self.obs[ind]
        ac_batch = self.acs[ind]
        re_batch = self.rews[ind]
        next_ob_batch = self.next_obs[ind]
        terminal_batch = self.terminals[ind]
